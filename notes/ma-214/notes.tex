...
\subsection{LU Factorisation}
	...
	Note that $A^{(2)}$ will be a matrix identical to the first one with respect to the last $n-1$ columns. However, its first column will just have the top element non-zero and everything below will be zero.\\~\\
